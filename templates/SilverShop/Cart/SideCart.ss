        ...
        <% with $Cart %>
            ...
            <% loop $Items %>
                <div class="item $EvenOdd $FirstLast">
                    ...
                    <a class="remove" href="$removeallLink" title="<%t SilverShop\Cart\ShoppingCart.RemoveTitle "Remove &quot;{Title}&quot; from your cart." Title=$TableTitle %>"><i class="fa fa-times"></i></a>
                </div>
            <% end_loop %>
        <% end_with %>
    <% else %>
